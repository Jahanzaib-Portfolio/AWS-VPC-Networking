...
![VPC Dashboard Setup](images/image1.png)
![Specify VPC Name and CIDR Block](images/image2.png)
...
![Create Subnet Option](images/image3.png)
![Configure Public Subnet Form](images/image4.png)

- Create a Private Subnet with CIDR block 10.0.2.0/24 in the same availability zone.

![Configure Private Subnet Settings](images/image5.png)
![Review Configured Subnets List](images/image6.png)
...
![Create Internet Gateway View](images/image7.png)

- Once created, note that its initial state is detached.

![Internet Gateway Detached Status Display](images/image8.png)

- Select Actions -> Attach to VPC, choose your custom VPC from the drop-down list, and confirm the attachment.

![Select Attach to VPC Option](images/image9.png)
![Confirm VPC Attachment Panel](images/image10.png)
...
![Create Public Route Table Form](images/image11.png)

- Create another standalone Route Table for your private traffic paths.

![Create Private Route Table Form](images/image12.png)
![Review Route Tables Dashboard Grid](images/image13.png)
...
![Edit Public Subnet Associations Grid](images/image14.png)
![Confirm Associated Public Subnet View](images/image15.png)
...
![Add Internet Route to Public Table](images/image16.png)
...
![Create NAT Gateway Configuration Window](images/image17.png)
![NAT Gateway Form Allocation Fields](images/image18.png)
...
![Edit Private Subnet Associations Grid](images/image19.png)
...
![Add NAT Gateway Route to Private Table](images/image20.png)
...
![Enable Auto Assign Public IP in Settings](images/image21.png)
...
![Configure Security Group Inbound ICMP Rules](images/image22.png)
![Save Inbound Security Firewall Rule Changes](images/image23.png)
...
![Launch Wizard Subnet Placement Options](images/image24.png)
![Public Subnet EC2 Instance Details Display](images/image25.png)
...
![Launch Wizard Private Placement Setup](images/image26.png)
![Private Subnet EC2 Instance Details Display](images/image27.png)
...
![Local Workstation Ping Test to Public Host Terminal](images/image28.png)

- Use your terminal command prompt to establish a secure SSH connection straight into the public EC2 machine.

![SSH Command Prompt into Public Server Host](images/image29.png)
...
![Internal VPC Ping from Public to Private Host](images/image30.png)
...
![Establish SSH Session on Remote Private Machine](images/image31.png)
![Confirm Successful Shell Landing on Private Host](images/image32.png)
...
![Outbound Web Query Ping from Isolated Private Host](images/image33.png)
![Verify DNS Resolution on Private Machine Terminal](images/image34.png)
...
![Check Private Instance Operating System Properties](images/image35.png)
![Verify Subnet Adapter Metrics inside Terminal Session](images/image36.png)
![Complete End to End Traffic Routing Verification Check](images/image37.png)
![Final Active Network Mesh Resource Overview](images/image38.png)
